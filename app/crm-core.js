...
export async function assistChat(messages, leadContext) {
  if (DEMO) {
    ...
    return { ok: true,
      ...
      seen: 'Lead: whats the damage, whats this cost\nSetter: depends on the store honestly\nLead: ballpark?' };
  }
